...
def main():
    ...
    if data_args.dataset_name is not None:
        ...
        # )
        raw_datasets = datasets.load_from_disk(dataset_path='/home/moja/Desktop/finalproj/wmt_data')
    else:
        data_files = {}
    ...
    train_dataset = raw_datasets["train"].train_test_split(test_size=int(0.998 * length), train_size=int(0.002 * length), seed=2022)
    raw_datasets["train"] = train_dataset["train"]
    raw_datasets["test"] = train_dataset["test"].shard(num_shards=998, index=0)
    print(f"------------------------------------")
    print(f"train_dataset = {train_dataset}")
    print(f"raw_dataset = {raw_datasets}")
    print(f"------------------------------------")
