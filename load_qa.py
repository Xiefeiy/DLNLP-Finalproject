...
def main():
    ...
    if data_args.dataset_name is not None:
        ...
        # )
        raw_datasets = datasets.load_from_disk(dataset_path='/home/moja/Desktop/finalproj/squad_data')
    else:
        data_files = {}
    ...
    train_dataset = raw_datasets["train"].train_test_split(test_size=int(0.1 * length), train_size=int(0.9 * length), seed=2022)
    raw_datasets["train"] = train_dataset["train"]
    raw_datasets["test"] = train_dataset["test"]
    print(f"------------------------------------")
